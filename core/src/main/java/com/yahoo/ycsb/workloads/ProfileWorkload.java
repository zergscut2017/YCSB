 ...
 * <LI><b>prekeyinregion</b>: should provide a prefix for the keys (default: "user")
 * </ul>
 */
public class ProfileWorkload extends Workload {
  ...
  /**
   * prekey for the key in usertable.
   */
  public static final String PREKEY_IN_REGION = "prekeyinregion";
  public static final String PREKEY_IN_REGION_DEFAULT = "user";
  ...
  protected String prekeyinregion;
  ...
  public void init(Properties p) throws WorkloadException {
    ...
    fieldlengthgenerator = ProfileWorkload.getFieldLengthGenerator(p);

    prekeyinregion = p.getProperty(PREKEY_IN_REGION, PREKEY_IN_REGION_DEFAULT);
  ...
  private NFProfile buildSingleValue(String key) {
    ...
    NFSingleNssai snssai = buildSnssai();
